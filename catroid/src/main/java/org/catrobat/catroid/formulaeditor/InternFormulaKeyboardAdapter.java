...
public class InternFormulaKeyboardAdapter {
    ...
    public List<InternToken> createInternTokenListByResourceId(int resource, String name) {
		...
		switch (resource) {
			...
			case R.string.formula_editor_function_table_join:
				return buildTripleParameterFunction(Functions.TABLE_JOIN, STRING,"myTable", STRING,",", STRING,"\n");
            ...
            case R.string.formula_voxel_get_data:
                return buildFourParameterFunction(Functions.VOXEL_GET_DATA,
                        STRING, "chunk1",
                        NUMBER, "0",
                        NUMBER, "0",
                        NUMBER, "0");
			...
			case R.string.formula_editor_function_connect:
				return buildDoubleParameterFunction(Functions.CONNECT, STRING, "list_name", STRING, ",");
			case R.string.formula_editor_function_find:
				return buildDoubleParameterFunction(Functions.FIND, STRING, "list_name", STRING, "256");
			...
			case R.string.formula_editor_object_width:
				return buildObject(Sensors.OBJECT_WIDTH);
			case R.string.formula_editor_object_height:
				return buildObject(Sensors.OBJECT_HEIGHT);
			...
			case R.string.formula_editor_object_look_width:
				return buildObject(Sensors.OBJECT_LOOK_WIDTH);
			case R.string.formula_editor_object_look_height:
	...
	private List<InternToken> buildFourParameterFunction(Functions function, InternTokenType firstParameter,
														   String firstParameterNumberValue, InternTokenType secondParameter, String secondParameterNumberValue,
														   InternTokenType thirdParameter, String thirdParameterNumberValue, InternTokenType fourParameter, String fourParameterNumberValue) {
		List<InternToken> returnList = new LinkedList<InternToken>();
		returnList.add(new InternToken(FUNCTION_NAME, function.name()));
		returnList.add(new InternToken(FUNCTION_PARAMETERS_BRACKET_OPEN));
		returnList.add(new InternToken(firstParameter, firstParameterNumberValue));
