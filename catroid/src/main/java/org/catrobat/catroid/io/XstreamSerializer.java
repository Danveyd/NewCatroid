...
public final class XstreamSerializer {
	...
	private void prepareXstream(Class projectClass, Class sceneClass) {
        ...
        xstream.alias("brick", ZipProjectFilesBrick.class);
        xstream.alias("brick", UnzipProjectFilesBrick.class);
        xstream.alias("brick", HttpCreateBrick.class);
        xstream.alias("brick", HttpConfigBrick.class);
        xstream.alias("brick", HttpBodyBrick.class);
        xstream.alias("brick", HttpAttachFileBrick.class);
        xstream.alias("brick", HttpSendBrick.class);
        xstream.alias("brick", HttpSaveFileBrick.class);
        xstream.alias("brick", VoxelBuildBrick.class);
        xstream.alias("brick", VoxelDeleteBrick.class);
        xstream.alias("brick", VoxelLoadStringBrick.class);
        xstream.alias("brick", VoxelCreateWorldBrick.class);
        xstream.alias("brick", VoxelSetTransparentBrick.class);
        xstream.alias("brick", VoxelSetBlockBrick.class);
        xstream.alias("brick", VoxelConfigBrick.class);
		xstream.alias("brick", Set3dPositionBrick.class);
        xstream.alias("brick", ThreedCreateFixedConstraintBrick.class);
        xstream.alias("brick", ThreedAlignNormalBrick.class);
        xstream.alias("brick", ThreedCreateCylinderBrick.class);
        xstream.alias("brick", ThreedAttachObjectToBoneBrick.class);
        xstream.alias("brick", ThreedBindBoneToObjectBrick.class);
        xstream.alias("brick", GenerateKeyBrick.class);
        xstream.alias("brick", SignApkBrick.class);
        xstream.alias("brick", UpdateManifestBrick.class);
        xstream.alias("brick", ExtractFileBrick.class);
        xstream.alias("brick", AddFileToApkBrick.class);
        xstream.alias("brick", DeleteFromApkBrick.class);
        ...
        xstream.alias("brick", SetShadowQualityBrick.class);
        ...
        xstream.alias("brick", RunChip8Brick.class);
        xstream.alias("brick", SetAIBrick.class);
        xstream.alias("brick", Fast2DSetRotationBrick.class);
        xstream.alias("brick", Fast2DSetScaleBrick.class);
        xstream.alias("brick", Fast2DSetTextureBrick.class);
        ...
        xstream.alias("brick", Fast2DSetAngularVelocityBrick.class);
        xstream.alias("brick", Fast2DApplyForceBrick.class);
        xstream.alias("brick", Fast2DApplyImpulseBrick.class);
        xstream.alias("brick", Fast2DSetPhysicsVelocityBrick.class);
        ...
        xstream.alias("brick", AddToBufferBrick.class);
        xstream.alias("brick", SetBufferCameraBrick.class);
        xstream.alias("brick", ApplyBufferLookBrick.class);
        xstream.alias("brick", SetBufferOnlyBrick.class);
        xstream.alias("brick", SetHingeMotorBrick.class);
        ...
        xstream.alias("brick", PtSetTrainingBrick.class);
        xstream.alias("brick", PtReshapeBrick.class);
        xstream.alias("brick", PtSetTensorBrick.class);
        xstream.alias("brick", PtSetByIndexBrick.class);
        ...
        xstream.alias("brick", BufferMaskBrick.class);
        xstream.alias("brick", SetNativeParentBrick.class);
        xstream.alias("brick", CreateScrollViewBrick.class);
        xstream.alias("brick", CreateTextLabelBrick.class);
        xstream.alias("brick", NativeViewConfigBrick.class);
        xstream.alias("brick", NativeViewControlBrick.class);
        xstream.alias("brick", NativeViewListenerBrick.class);
        xstream.alias("brick", CreateButtonBrick.class);
        xstream.alias("brick", CreateSwitchBrick.class);
        xstream.alias("brick", CreateImageViewBrick.class);
        xstream.alias("brick", CreateSliderBrick.class);
        xstream.alias("brick", NativeViewAnimateBrick.class);
        xstream.alias("brick", NativeViewBindSpriteBrick.class);
        xstream.alias("brick", ShowNotificationBrick.class);
        xstream.alias("script", WhenSpriteReleasedScript.class);
        xstream.alias("script", WhenFingerMovedOverSpriteScript.class);
        xstream.alias("script", WhenFingerMovedOnScreenScript.class);
        xstream.alias("script", BroadcastWithParamsReceiverScript.class);
        xstream.alias("brick", BroadcastWithParamsBrick.class);
        xstream.alias("brick", BroadcastWithParamsReceiverBrick.class);
        xstream.alias("brick", WhenNotificationClickedBrick.class);
        xstream.alias("script", WhenNotificationClickedScript.class);
        xstream.alias("brick", NotificationCreateBrick.class);
        xstream.alias("brick", NotificationShowBrick.class);
        xstream.alias("brick", EnableBackgroundModeBrick.class);
        xstream.alias("brick", DisableBackgroundModeBrick.class);
        xstream.alias("brick", NotificationAddButtonBrick.class);
        xstream.alias("script", WhenNotificationActionTriggeredScript.class);
        ...
        xstream.alias("brick", SpawnParticleInstanceBrick.class);
        xstream.alias("brick", SetParticleBufferRenderBrick.class);
        xstream.alias("brick", SetParticleTransformBrick.class);
        xstream.alias("brick", SetParticlePropertyBrick.class);
        xstream.alias("brick", EmitParticleBurstBrick.class);
        xstream.alias("brick", StopParticleInstanceBrick.class);
        xstream.alias("brick", UpdateScreenBrick.class);
