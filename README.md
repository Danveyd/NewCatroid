...
**📚 Документация:** [Библиотеки (.newlib)](docs/libraries.ru.md) • [Плагины (.nplug)](docs/plugins.ru.md) • [English docs](docs/libraries.en.md) • [Documentação em português](docs/libraries.pt-BR.md)
...
*   **Библиотеки:** Создание своих блоков и формул на языке LunoScript. [Подробнее](docs/libraries.ru.md)
*   **Плагины:** Кастомизация основного интерфейса. [Подробнее](docs/plugins.ru.md)
...
*   **Сообщество NewCatroid:** Интеграция с [собственным сайтом комьюнити](https://newcatroid.sois.site)
